...
docker compose exec -u root mosquitto sh -c '> /mosquitto/config/passwd'
docker compose exec -u root mosquitto mosquitto_passwd -b /mosquitto/config/passwd sensor01 "$MQTT_SENSOR01_PASS"
